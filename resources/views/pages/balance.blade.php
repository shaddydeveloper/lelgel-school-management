                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Fee Balance</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body row">
                                <form action="{{ route('make_payment') }}" method="POST" class="row" id="student-form">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label for="referrence" class="form-label">Referrence <span><i>(Applies on
                                                    Mpesa and Bank)</i></span></label>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header  col-12">
                                <h3 class="card-title">List of Students with a fee Balance</h3>
                                <a href="#" class="btn btn-info float-right" data-toggle="modal"
                                    data-target="#modal-overlay">Record Payment</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($balances as $balance)
                                            <tr>
                                                ...
                                                <td>KSH {{ $balance->amount }}</td>
                                                <td>
                                                    @if ($balance->last_payed == '')
                                                        N/A
                                                    @else
                                                        {{ $balance->last_payed }}
                                                    @endif
                                                </td>
                                                <td>{{ $balance->parent_number }}</td>
