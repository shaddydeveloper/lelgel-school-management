...
<head>
    ...
    <title>{{ $apparator_info->name }} | Lelgel Secondary School</title>
                ...
                <a href="#" class="nav-link">
                  ...
                  <p>Supplies</p>
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('apparatus') }}" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Apparatus</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('chemicals') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Chemicals</p>
                                    </a>
                                </li>
                ...
                <section style="background-color: #eee;">
                    <div class="container py-2">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card mb-4">
                                    <form action="{{ route('update_apparator', $apparator_info) }}" method="post">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <p class="mb-0">Apparator Name</p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="name"
                                                        value="{{ $apparator_info->name }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" name="quantity" id="quantity"
                                                        ...
                                                        value="{{ $apparator_info->quantity }}" required>
                                                </div>
                                            </div>
                                            <hr>
