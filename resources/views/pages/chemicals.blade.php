@extends('layouts.admin', [
    'title' => 'Chemicals',
    'class_laboratory_management' => 'active',
    'class_open_laboratory_management' => 'menu-open',
    'class_chemicals' => 'active',
])
@section('content')
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body row">
                                <form action="{{ route('add_chemical') }}" method="POST" class="row" id="student-form">
                                    {{ csrf_field() }}
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header  col-12">
                                <h3 class="card-title">List of Laboratory Chemicals</h3>
                                <a href="#" class="btn btn-info float-right" data-toggle="modal"
                                    data-target="#modal-overlay">Add Chemical</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($chemicals as $chemical)
                                            <tr>
                                                ...
                                                <td>{{ $chemical->quantity . ' ' . $chemical->unit_of_measure }}
                                                </td>
                                                <td>
                                                    <div class="action-buttons d-flex p-2">
                                                        <a href="{{ route('edit_chemical', $chemical) }}"
                                                            class="btn btn-success mr-2"><i class="fa fa-edit"></i></a>
                                                        <form
                                                            action="{{ route('chemical.delete', $chemical->chemical_id) }}"
                                                            method="post">
                                                            @csrf
